...
const methodInit = 'asynchronous merge sort array only for time ';
const merge_sort = async (data, method = methodInit) => {
    let result, output;
    try {
        result = await SortLib.merge_sort_array_async(data.scope, true);
